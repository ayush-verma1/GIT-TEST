    ...
    render() {
        return (
            <div>
                <div class="container">
							<h3>Vision</h3>
                            <p>To be a premier institute where engineering education and research converge to produce engineers as responsible citizens.</p>
                            ...
                            <h3><strong>Program Educational Objectives (PEOs)</strong></h3>
                            <ul>
                                ...
                                <li>To develop the department by conducting faculty development programs and also encouraging their participation in conferences, seminars,workshops and guest lectures at national level and international level.</li>
                                <li>To develop the skills of the staff by conducting staff development programs and encourage participate in them.</li>
                                <li>The engineers from LNCT should be intelligent, knowledgeable and diligent towards their job responsibility they should accept social responsibility with a confidence, ethics,patriotism and high character.</li>
                                <li>The engineers passing out from this college should respect their elders, considerate among their colleagues, religious, tolerant, culture loving, nature loving and cooperative with teams.</li>
                            </ul>						
                </div>
            </div>
        );
